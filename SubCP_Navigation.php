...
<table width="132" border="1" align="left" class="menu" style="background-color:#F9F9F9;">
  ...
  <tr>
    <td bordercolor="#F9F9F9"></td>
    <td bordercolor="#F9F9F9"><a href="Admin.php"><img alt="Control Panel Administration" border="0" src="../images/Administration.gif" width="16" height="16" style="cursor:hand;"></a></td>
    <td class="menu" bordercolor="#F9F9F9"><a href="Admin.php">Administration</a></td>
  </tr>
  <?php } ?>
  <tr>
	<td bordercolor="#F9F9F9"></td>
